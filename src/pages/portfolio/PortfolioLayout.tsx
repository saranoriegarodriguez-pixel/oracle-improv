...
import { useLang, useSwitchLangPath, withLang, useHtmlLang } from "./lang";
...
export default function PortfolioLayout() {
  ...
  // ✅ sincroniza <html lang="es|en"> con la URL
  useHtmlLang();
  ...
  return (
    <div className="portfolioLayout">
      <header className="portfolioTopbar">
        ...
        <nav className="portfolioTopbar__nav" aria-label="Portfolio">
